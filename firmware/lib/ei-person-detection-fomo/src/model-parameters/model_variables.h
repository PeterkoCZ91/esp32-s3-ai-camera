...
const char* ei_classifier_inferencing_categories_899019_1[] = { "hum" };

EI_CLASSIFIER_DSP_AXES_INDEX_TYPE ei_dsp_config_899019_3_axes[] = { 0 };
const uint32_t ei_dsp_config_899019_3_axes_size = 1;
ei_dsp_config_image_t ei_dsp_config_899019_3 = {
    3, // uint32_t blockId
...
ei_model_dsp_t ei_dsp_blocks_899019_1[ei_dsp_blocks_899019_1_size] = {
    { // DSP block 3
        ...
        ei_dsp_config_899019_3_axes_size, // number of axes
        1, // version
...
const uint8_t freeform_outputs_899019_1_size = 0;

uint32_t *freeform_outputs_899019_1 = nullptr;

const ei_impulse_t impulse_899019_1 = {
    .project_id = 899019,
    .project_owner = "petrppan",
    ...
    .dsp_blocks_size = ei_dsp_blocks_899019_1_size,
    .dsp_blocks = ei_dsp_blocks_899019_1,

    .learning_blocks_size = ei_learning_blocks_899019_1_size,
    .learning_blocks = ei_learning_blocks_899019_1,

    .postprocessing_blocks_size = ei_postprocessing_blocks_899019_1_size,
    .postprocessing_blocks = ei_postprocessing_blocks_899019_1,
    ...
    .label_count = 1,
    .categories = ei_classifier_inferencing_categories_899019_1,
    .results_type = EI_CLASSIFIER_TYPE_OBJECT_DETECTION,
    .freeform_outputs_size = freeform_outputs_899019_1_size,
    .freeform_outputs = freeform_outputs_899019_1
};

ei_impulse_handle_t impulse_handle_899019_1 = ei_impulse_handle_t( &impulse_899019_1 );

ei_impulse_handle_t& ei_default_impulse = impulse_handle_899019_1;
constexpr auto& ei_classifier_inferencing_categories = ei_classifier_inferencing_categories_899019_1;
const auto ei_dsp_blocks_size = ei_dsp_blocks_899019_1_size;
ei_model_dsp_t *ei_dsp_blocks = ei_dsp_blocks_899019_1;
